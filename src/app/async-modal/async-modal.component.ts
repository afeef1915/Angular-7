...
@Component({
  selector: 'app-async-modal',
  templateUrl: './async-modal.component.html',
  styleUrls: ['./async-modal.component.css']
})
export class AsyncModalComponent implements OnInit {
  ...
  getStatesAsObservable( token: string): Observable<any>  {
    ...
    return of(
      this.statesComplex.filter(( states: any) => {
        return query.test(states.name);
      })
